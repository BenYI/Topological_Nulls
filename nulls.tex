...
\usepackage[size=custom,width=152,height=108]{beamerposter}
%\usepackage{wrapfig}
...
\begin{block}{Topological Index}
  ...
  The degree of the map counts the topological index of the nulls,
  and is robust to perturbation.
\end{block}
\end{block}
...
\begin{block}{Nulls Near Singular Surfaces}
  \begin{itemize}
   ...
   \end{itemize}
   \begin{figure}
     \includegraphics[width=.5\textwidth]{/fig/singular/fig_edit_color.png}
     \hfill
...
\begin{figure}
    \centering
  \qrcode[height=7cm]{https://github.com/BenYI/Topological_Nulls}
\end{figure}
\end{block}
\end{column}
