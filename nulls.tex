...
\begin{block}{Deriving the Isotrope Field}
  ...
  \fbox{
    ...
    \begin{minipage}{\textwidth}
      ...
      on $S^2$ with $\omega=d\alpha\wedge d\beta J(\alpha,\beta)$,
      ...
      \begin{equation}
        ...
        =\int_{g_*\partial U}d\alpha d\beta J(\alpha,\beta)
        =\int_{\partial U}dxdy
        \begin{vmatrix}
...
\begin{column}{\sepwid}\end{column} % Empty spacer column
%----------------------------------------------------------------------------------------
\begin{column}{\onecolwid} %Start column 3
